...
// export const getGroceries = async (req, res) => res.send({ groceries: await middleware.groceries() });

// export const getRecipe = async (req, res) => res.send({ recipe: await middleware.recipe() });
