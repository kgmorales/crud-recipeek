									...
									<div className='form-login bg-gray-850 border-gray-800 text-start'>
										<form action='#'>
											...
											<div className='form-group position-relative'>
												<input className='form-control bg-gray-850 border-gray-800 password' type={passwordShown ? 'text' : 'password'} placeholder='Password' />
												<span className='viewpass' onClick={togglePasswordVisiblity} />
											</div>
											<div className='form-group position-relative'>
												<input className='form-control bg-gray-850 border-gray-800 password' type={passwordShown ? 'text' : 'password'} placeholder='Confirm password' />
												<span className='viewpass' onClick={togglePasswordVisiblity} />
											</div>
											<div className='form-group'>
												<button className='btn btn-linear color-gray-850 hover-up' type='submit'>
													Create an account
												</button>
											</div>
											<div className='form-group mb-0'>
												<span>Already have an account?</span>
												<Link className='color-linear' href='/page-login'>
													{' '}
													Sign In
												</Link>
											</div>
